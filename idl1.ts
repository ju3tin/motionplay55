  ...
  "instructions": [
    {
      "name": "claim_prize",
      "docs": [
        "Winner claims the full vault balance."
      ],
      "discriminator": [
        157,
        233,
    ...
    },
    {
      ...
      "accounts": [
        ...
        },
        {
          "name": "vault",
          "docs": [
            "The vault is a plain PDA that holds lamports — use UncheckedAccount + init",
            "via system_program::create_account, or simply let it receive lamports as a",
            "PDA address. We mark it as UncheckedAccount so Anchor doesn't try to",
            "deserialise it."
          ],
          "writable": true,
          "pda": {
    ...
    },
    {
      "name": "finalize",
      "docs": [
        "Called by the oracle (competition creator) after finish_time."
      ],
      "discriminator": [
        171,
        61,
    ...
    },
    {
      "name": "submit_score",
      "docs": [
        "Player submits a score. Callable any time between start_time and finish_time.",
